          ...
          <span className={`${as.NavSublist} NavList`}>
            <ul id={as.tradeDropdown}>
              ...
              >
                ...
                <div className={`${as.li2} d-flex flex-column`}>
                  <div className={as.li2a}>Login</div>
                  <div className={as.li2b}> Login then Earn double rewards</div>
                </div>
              </li>
          ...
          <span className={`${as.NavSublist} NavList`}>
            <ul id={as.tradeDropdown}>
              ...
              >
                ...
                <div className={`${as.li2} d-flex flex-column`}>
                  <div className={as.li2a}>Buy& Sell </div>
                  <div className={as.li2b}>Buy and sell Sikka Coin, and other digital assets</div>
                </div>
              </li>
